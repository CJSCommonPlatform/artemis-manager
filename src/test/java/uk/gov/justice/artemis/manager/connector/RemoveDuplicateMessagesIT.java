...
public class RemoveDuplicateMessagesIT {
    ...
    public void shouldRemoveMessageDuplicates() throws Exception {
        ...
        assertThat(messageData_1.get(1).getConsumer(), is(consumer_1));
        ...
        assertThat(messageData_1.get(2).getConsumer(), is(consumer_1));
        ...
        final List<String> listOfMessageIds = combinedArtemisConnector.removeAllDuplicates(queue);

        assertThat(listOfMessageIds.size(), is(1));

        final List<MessageData> messageData_2 = combinedArtemisConnector.messagesOf(queue);

        assertThat(messageData_2, hasSize(2));
